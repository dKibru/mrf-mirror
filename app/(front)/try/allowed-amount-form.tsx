...
import { sampleAllowedAmountUrls } from "@/configs";
...
export const AllowedAmountForm = () => {
  ...
  const fillSample = (index: number) => {
    const sample = sampleAllowedAmountUrls[index];
    ...
    <>
      <div className="pointer-events-auto mx-auto max-w-2xl rounded-xl bg-white pt-1 border-none ">
        <p className="text-sm leading-6 text-gray-900 text-justify">
          Try our real-time Allowed Amounts MRF processing tools for free and
          see how quickly and efficiently we handle even the most complex files.
          Our trial is limited to 1,000 rows, giving you a taste of how we can
      ...
      <div className="flex flex-wrap justify-center pb-5">
        {sampleAllowedAmountUrls.map((sample, index) => (
          <Badge
            variant="outline"
            key={sample.url}
